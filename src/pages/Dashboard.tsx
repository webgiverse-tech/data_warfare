...
const Dashboard: React.FC = () => {
  ...
  const analysesUsedPercentage = profile && profile.analyses_count && profile.analyses_remaining !== null
  ...
  return (
    <div className="container mx-auto p-8 min-h-[calc(100vh-160px)] flex flex-col bg-dw-background-deep text-dw-text-primary">
      ...
      <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }}>
        <QuotaGauge profile={profile} analysesUsedPercentage={analysesUsedPercentage} />
      </motion.div>

      <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.9 }}>
        <AnalysisHistoryTable
          ...
          setAnalysisToDeleteId={setAnalysisToDeleteId}
      ...
      <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1.1 }}>
        <QuickActions
      ...
      <ReportModal
        ...
        selectedAnalysisReport={selectedAnalysisReport}
