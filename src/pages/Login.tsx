...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-160px)] flex items-center justify-center bg-dw-background-deep p-4">
      ...
      >
        <h1 className="text-3xl font-heading gradient-text text-center mb-8 relative bg-gradient-to-r from-dw-accent-primary to-dw-accent-secondary hover:shadow-[0_0_30px_rgba(139,92,246,0.5)] text-dw-text-primary  px-6 py-2.5 rounded-lg transform transition-all duration-300 hover:scale-105 hover:-translate-y-0.5">
          Accès au Terminal
        </h1>
        <Auth
