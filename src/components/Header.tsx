              ...
              {navItems.map((item, index) => (
                <li key={index}>
                  ...
                  >
                    ...
                    <span className="absolute bottom-0 -top-2 left-0 w-0 h-0.5 bg-gradient-to-r from-dw-accent-primary to-dw-accent-secondary group-hover:w-full transition-all duration-300 shadow-[0_0_10px_currentColor]"></span>
                    {/* Glow effect */}
