...
import { Loader2, Search, Eye, Download, Share2, Trash2 } from 'lucide-react';
import { Analysis } from '@/pages/Dashboard'; // Assuming Analysis type is exported from Dashboard
...
interface AnalysisHistoryTableProps {
  ...
  handleExportPdf: () => void; // This will export the currently viewed report
  handleCopyLink: (analysisId: string) => void;
  handleDeleteClick: (analysisId: string) => void;
}
